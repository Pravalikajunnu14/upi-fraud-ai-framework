...
class Config:
    # In production (Render), these MUST be set as environment variables
    # For local development, using defaults is okay
    ...
    # ── Email alert config ──────────────────────────────────────
    # Email settings - optional in production (alerts just won't send)
