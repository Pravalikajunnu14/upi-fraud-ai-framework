...
class Config:
    ...
    # ── Email alert config ──────────────────────────────────────
    ALERT_EMAIL_FROM     = os.getenv("ALERT_EMAIL_FROM", "pravalikajunnu14@gmail.com")
    ALERT_EMAIL_PASSWORD = os.getenv("ALERT_EMAIL_PASSWORD", "ivhmtdgqdclzvrhu")
    ALERT_EMAIL_TO       = os.getenv("ALERT_EMAIL_TO", "pravalikajunnu14@gmail.com")
